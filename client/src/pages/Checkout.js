...
export default function Checkout() {
  ...
  const handlePayment = async (e) => {
    ...
    try {
      ...
      // 2. Confirm card payment (Stripe can now find the hidden element!)
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
          ...
          {/* Step 0: Shipping - Uses hidden class instead of unmounting */}
          <div className={`bg-white rounded-2xl p-6 border border-gray-100 shadow-sm ${step === 0 ? "block" : "hidden"}`}>
          ...
          {/* Step 1: Payment - Kept in DOM so Stripe can read it! */}
          <div className={`bg-white rounded-2xl p-6 border border-gray-100 shadow-sm ${step === 1 ? "block" : "hidden"}`}>
            <div className="flex items-center gap-2 mb-6">
          ...
          {/* Step 2: Review & Place */}
          <form onSubmit={handlePayment} className={`bg-white rounded-2xl p-6 border border-gray-100 shadow-sm ${step === 2 ? "block" : "hidden"}`}>
